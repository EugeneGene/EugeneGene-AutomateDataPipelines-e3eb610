...
#
# TODO[x]: Create a DAG which performs the following functions:
#
...
def full_pipeline():
#
# TODO[x]: Load trips data from S3 to RedShift. Use the s3_key
#       "data-pipelines/divvy/unpartitioned/divvy_trips_2018.csv"
#       and the udacity-dend s3_bucket
#
...
#
# TODO[x]: Perform a data quality check on the Trips table
#
...
#
# TODO[x]: Use the FactsCalculatorOperator to create a Facts table in RedShift. The fact column should
...
#calculate_facts = FactsCalculatorOperator(...)
#
# TODO[x]: Define task ordering for the DAG tasks you defined
#
